"""
Pol-angle gradient reconstructor: fit polarization angle vs λ².

Does not use the optimization pipeline; overrides reconstruct() to fit
a line to pol angle vs λ² and set reconstructed_phi_0 / reconstructed_y_value.
"""
...
class PolAngleGradientReconstructorWrapper(FaradayReconstructorWrapper):
    ...
    reconstructed_phi_0: float = field(init=False, default=0.0)
    reconstructed_y_value: float = field(init=False, default=0.0)
