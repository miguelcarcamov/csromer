...
class RMPlotter:
    ...
    def plot(
        ...
        if self.rm_image_error is not None and self.pol_fraction_image is not None:
            ...
            ax1.coords[1].set_ticklabel(exclude_overlapping=True)
            ax2.coords[0].set_axislabel("Right Ascension [J2000]")
            ax2.coords[1].set_axislabel("")
            ax2.coords[0].set_ticks(number=3)
            ax2.coords[0].set_ticklabel(exclude_overlapping=True)
            ax2.coords[1].set_ticks(number=4)
            ax2.coords[1].set_ticklabel(exclude_overlapping=True)
            ax3.coords[0].set_axislabel("Right Ascension [J2000]")
            ax3.coords[1].set_axislabel("")
            ax3.coords[0].set_ticks(number=3)
            ax3.coords[0].set_ticklabel(exclude_overlapping=True)
            ax3.coords[1].set_ticks(number=4)
            ax3.coords[1].set_ticklabel(exclude_overlapping=True)
